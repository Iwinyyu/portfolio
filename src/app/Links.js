  ...
  return (
    <Fragment>
      <ul className={` ${props.direction === "vertical" ? "[&>*]:flex [&>*]:flex-col [&>*]:items-center flex flex-col justify-center gap-10 items-center text-base":"[&>*]:flex [&>*]:flex-row hidden sm:flex gap-6 items-center text-sm"} font-Space  `}>
        <li className="transition ease-out cursor-pointer text-sub-color hover:text-yellow-color capitalize ">
        ...
        <li className="transition ease-out cursor-pointer text-yellow-color capitalize bg-yellow-color rounded-md">
