export default function Logo(fill) {
  return (
    <div className="relative w-[55px] h-[55px] logocontainer">
      ...
      className="w-[55px] h-[55px] absolute inset-0 animate-spin-slower transition transform ease-out fill-yellow-color"
    >
      <g clipPath="url(#clip0_192_137)">
        <path
    ...
    <span className="text-2xl text-yellow-color absolute font-extrabold ">IY</span>
    </button>
    </div>
  );
}
